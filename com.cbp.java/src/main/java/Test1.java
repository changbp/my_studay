 ...
 */
public class Test1 {
    private static final String KEY = "BF4703E6F8D88996";
    //偏移量，AES 128位数据块对应偏移量为16位
    public static final String VIPARA = "AB95B7A9B41D43EE";   //AES 128位数据块对应偏移量为16位
    ...
    public static void main(String[] args) {
        ...
        String pwassw = "123456";



        String enUser = Test1.encrypt(username, KEY);
        String enPwd = Test1.encrypt(pwassw, KEY);
        System.out.println("加密用户名=====》 " + enUser);
        System.out.println("加密密码=====》 " + enPwd);

        String deUser = Test1.decrypt(enUser, KEY);
        String dePwd = Test1.decrypt(enPwd, KEY);
